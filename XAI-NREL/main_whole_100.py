...
class main:
    def __init__(self, epochs, learning_rate, n_layers, n_head, use_CWT, freq0_scale1, wavelet_type, desired_scales_freqs_range, selected_time_division, window_size, signal):
        ...
        print('data_after.shape', data.shape)
        ...
        if use_CWT == 1 :
            for head in range(n_head):
                ...
                for i in range(num_classes):
                    ...
                    with open('./explanation/' + prefix + 'L' + str(i)  + '_whole_window_size' + str(window_size)+ '_freq0_scale1_'+str(freq0_scale1) +'_100.pickle', 'wb') as f:
    ...
    for use_CWT in [1]:
        ...
        for window_size in [500, 50]:
            ...
            for wavelet_type in ['gaus4']:
                ...
                df_result.to_csv('./'+"NREL_whole_"+str(freq0_scale1)+'_'+"_100.csv", index=False, sep=';')
