...
def show_eingen_vector(data, freqs_scales, f_s):
   ...
   # This list shows the 13 first harmonics of the mechanical faulty frequencies
   mechanical_freq = [3.82, 3.82*2, 3.82*3, 3.82*4, 3.82*5, 3.82*6, 3.82*7, 3.82*8, 3.82*9, 3.82*10, 3.82*11, 3.82*12, 3.82*13]
   ...
   for i in range(len(top_freqs)):
      # 200 is the maximum frequency range
      if top_freqs[i]< 200:
