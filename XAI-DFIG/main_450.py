        ...
        if use_CWT == 1 :
            for head in range(n_head):
                ...
                for i in range(num_classes):
                    ...
                    with open('./explanation/' + prefix + 'L' + str(i)  + '_window_size' + str(window_size)+ '_freq0_scale1_'+str(freq0_scale1) +'_450.pickle', 'wb') as f:
            ...
            for REU in ['300', '225', '150']:
                ...
                for speed in ['1590', '1560', '1530']:
                    ...
                    for wavelet_type in ['gaus4']:
                        ...
                        df_result.to_csv('./'+"DFIG_"+str(freq0_scale1)+'_'+"_450.csv", index=False, sep=';')
