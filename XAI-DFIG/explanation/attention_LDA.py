...
def show_eingen_vector(data, freqs_scales, f_s):
   ...
   # This list shows the mechanical faulty frequencies related to current signal
   mechanical_freq_current = [56, 156, 256, 356, 44, 144, 244, 344]
   # This list shows the mechanical faulty frequencies related to power
   mechanical_freq_power = [6, 106, 206, 306, 406, 94, 194, 294, 394]
   # Here we let the mechanical frequencies to have +/-1 error
   mechanical_freq_used =[]
   for fr in mechanical_freq_current:
   ...
   for i in range(len(top_freqs)):
      # 450 is the maximum frequency range
      if top_freqs[i]< 450:
